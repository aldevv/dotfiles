...
noremap <silent><Plug>(BujoProject) :call <SID>bujoproject()<CR>
noremap <silent><Plug>(BujoGlobal) :call <SID>bujoglobal()<CR>
noremap <silent><Plug>(BujoPrivate) :call <SID>bujoprivate()<CR>

function s:bujoproject()
if (expand('%') == 'todo.md')
  if &mod == 1
    :w!
    :bd
