...
vim.cmd [[au FileType js ++once lua require("packer.load")({'vim-closetag', 'vim-dispatch', 'emmet-vim'}, { ft = "js" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType ts ++once lua require("packer.load")({'vim-closetag', 'vim-dispatch', 'emmet-vim'}, { ft = "ts" }, _G.packer_plugins)]]
