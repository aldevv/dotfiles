...
M.load_mappings = function()
    ...
    map("n", "<c-h>", ":lua require('harpoon.ui').nav_file(1)<cr>", nor)
    map("n", "<c-n>", ":lua require('harpoon.ui').nav_file(2)<cr>", nor)
    map("n", "<c-e>", ":lua require('harpoon.ui').nav_file(3)<cr>", nor)
    map("n", "<c-t>", ":lua require('harpoon.ui').nav_file(4)<cr>", nor)
    map("n", "<c-s>", ":lua require('harpoon.ui').nav_file(5)<cr>", nor)
